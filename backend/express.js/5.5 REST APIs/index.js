...
app.post("/post-secret", async (req, res) => {
  try{
    ...
    res.render("index.ejs", { content: "cannot post you request" });
  }
});
...
app.post("/put-secret", async (req, res) => {
  ...
  try{
    ...
    res.render("index.ejs", { content: "cannot put you request" });
  }
...
app.post("/delete-secret", async (req, res) => {
  ...
  try{
    ...
    res.render("index.ejs", { content: "cannot delete you request" });
  }
